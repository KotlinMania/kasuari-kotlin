...
/**
 * This package contains an implementation of the Cassowary constraint solving algorithm, based upon
 ...
 * within the limitations of Kotlin's type system. Generally you can write constraints as you would
 ...
 *
 * First we need to include the relevant parts of `kasuari`:
 *
 * ```kotlin
 * import io.github.kotlinmania.io.github.kotlinmania.kasuari.WeightedRelation
 * import io.github.kotlinmania.io.github.kotlinmania.kasuari.Solver
 * import io.github.kotlinmania.io.github.kotlinmania.kasuari.Variable
 * ```
 *
 ...
 * ))
 * // throws AddConstraintError on failure
 * ```
 *
 ...
 * ```
 *
 * Note that the value of `box1.left` is not mentioned. This is because [Solver.fetchChanges] only
 ...
 *
 * ```kotlin
 * // setup repeated from earlier examples
 * // val names = mutableMapOf<Variable, String>()
 * //
 * // fun printChanges(names: Map<Variable, String>, changes: List<Pair<Variable, Double>>) {
 * //     println("Changes:")
 ...
 *
 * One thing that this example exposes is that this package is a rather low level library. It does
 * not have any inherent knowledge of user interfaces, directions or boxes. Thus for use in a user
 * interface this package should ideally be wrapped by a higher level API, which is outside the scope
 * of this package.
 */
