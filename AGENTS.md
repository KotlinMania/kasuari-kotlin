# Agent guide - kasuari-kotlin

This file is the quick-reference operating contract for kasuari-kotlin. The longer
...
kasuari-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`kasuari`](./README.md). Upstream Rust is the behavioral oracle while the
