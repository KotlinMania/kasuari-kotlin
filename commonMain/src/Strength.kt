 ...
 * solver. Each constraint added to the solver has an associated strength specifying the
 * precedence the solver should impose when choosing which constraints to enforce. It will try to
 * enforce all constraints, but if that is impossible the lowest strength constraints are the
...
data class Strength(private val value: Double) : Comparable<Strength> {
    ...
    companion object {
         ...
         *
         * This is the strongest possible strength.
         */
         ...
         *
         * This is weaker than [REQUIRED] but stronger than [MEDIUM].
         */
         ...
         *
         * This is weaker than [STRONG] but stronger than [WEAK].
         */
         ...
         *
         * This is weaker than [MEDIUM] but stronger than `0.0`.
         */
        val WEAK: Strength = Strength(1.0)

        /**
         * The weakest possible strength for a constraint.
         *
         * This is weaker than [WEAK].
         */
        val ZERO: Strength = Strength(0.0)

        /**
         * Create a new strength with the given value, clipped to the legal range
         * `(0.0, REQUIRED)`.
         */
        ...
        /**
         * Create a constraint as a linear combination of [STRONG], [MEDIUM] and [WEAK]
         * strengths.
         *
         * Each weight is multiplied by the multiplier, clamped to the legal range and then
         * multiplied by the corresponding strength. The resulting strengths are then summed.
         */
