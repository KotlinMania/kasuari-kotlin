...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Kasuari.swiftmodule/`
...
//      `import Kasuari` above would fail at compile time.
//
//   2. The static archive `libKasuari.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Kasuari" }` and
//      `flattenPackage = "io.github.kotlinmania.kasuari"` configuration in
...
//      via the `KasuariLibrary` product.
//
...
final class KasuariExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Kasuari swift module imported cleanly")
    }
}
